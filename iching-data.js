...
$rootScope.no_divination = {question:{value:""}, coins:["","","","","",""], time:"", hexagramNow:{number:"", name:"", lines:[-1,-1,-1,-1,-1,-1], trigram1:"", trigram2:"", ndx:-1, key:-1}, hexagramNext:{number:"", name:"", lines:[-1,-1,-1,-1,-1,-1], trigram1:"", trigram2:"", ndx:-1, key:-1}};
...
$rootScope.linePatterns = ['---- ----', '---------','--- X ---', '----0----'];
// Coin patterns and their associated line types
$rootScope.lineValues = [
...
// Hexagram domain list (array)
let xHexDomains = [
  { Domain: "https://cafeausoul.com/iching/", ID: "HexagramsCafeAuSoul" },
  { Domain: "http://www.jamesdekorne.com", ID: "HexagramsJamesDekorne" },
  { Domain: "https://divination.com/iching/", ID: "HexagramsDivination" },
  { Domain: "http://the-iching.com", ID: "HexagramsTheiChing" },
  { Domain: "http://inthefamilyway.org/iching/", ID: "HexagramsInTheFamilyWay" }
];

// Info from various iChing websites
$rootScope.iChingInfo = [
  { Domain: "https://cafeausoul.com/iching/", Short: "CafeAuSoul.com", Hexagrams: [
  ...
  { Domain: "http://www.jamesdekorne.com", Short: "JamesDekorne.com", Hexagrams: [
  ...
  { Domain: "https://divination.com/iching/", Short: "Divination.com", Hexagrams: [
  ...
  { Domain: "http://the-iching.com", Short: "The-iChing.com", Hexagrams: [
  ...
  { Domain: "http://inthefamilyway.org/iching/", Short: "InTheFamilyWay.org", Hexagrams: [
...
// Info from the cafeausoul.com website
let HexagramsCafeAuSoul = [
  {   Key: "111111",  url: "https://cafeausoul.com/iching/qian-creative",  Name: "1 - Qián (The Creative)",      },  //63 111 111
  {   Key: "000000",  url: "https://cafeausoul.com/iching/kun-receptive",  Name: "2 - K'un (The Receptive)",     },  //00 000 000
  {   Key: "010001",  url: "https://cafeausoul.com/iching/chun-difficult-beginnings",  Name: "3 - Chun (Difficult Beginnings)",       },  //17 010 001
  {   Key: "100010",  url: "https://cafeausoul.com/iching/meng-youthful-folly",  Name: "4 - Meng (Youthful Folly)",     },  //34 100 010
...
// Info from the inthefamilyway.org website
let HexagramsInTheFamilyWay = [
  {   Key: "111111",  url: "http://inthefamilyway.org/iching/hexagrams/h1/",  Name: "1 - Inspiring Force/Creator QIAN",      },  //63 111 111
  {   Key: "000000",  url: "http://inthefamilyway.org/iching/hexagrams/h2/",  Name: "2 - Field/Midwife KUN",     },  //00 000 000
  {   Key: "010001",  url: "http://inthefamilyway.org/iching/hexagrams/h3/",  Name: "3 - Sprouting ZHUN",       },  //17 010 001
  {   Key: "100010",  url: "http://inthefamilyway.org/iching/hexagrams/h4/",  Name: "4 - Enveloping MENG",     },  //34 100 010
